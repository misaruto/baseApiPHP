...
class UploadImagens{
    ...
    function __construct(){
        ...
        public function cidade($id, $img){            
            ...
            if(array_key_exists($img['type'], $this->extensoes)){
                
                $novoNome = 'cidade'.$id.$this->extensoes[$img['type']];
        ...
        public function categoria($id, $img){            
            ...
            if(array_key_exists($img['type'], $this->extensoes)){
                ...
                $novoNome = 'default'.$id.$this->extensoes[$img['type']];
        ...
        public function negocio($id, $img){            
            ...
            if(array_key_exists($img['type'], $this->extensoes)){
                ...
                $novoNome = 'produtor'.$id.$this->extensoes[$img['type']];
                $destino = DIREQ.'public/img/produtores/'.$novoNome;
